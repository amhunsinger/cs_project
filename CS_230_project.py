...
We worked as a team to come up with ways to represent the data the best way we knew how, making it easier to analyze and present to our class.
...
st.write("""Presented above is the raw data of the air qualities we examined for this project. 
    Indicated above is the Air quality Index, different types of particulate matter, and descriptions of each country. 
    We used this data to showcase which countries had the best air quality and how they came to be like that. 
    For example, take …, based on the data collected, it can be determined that Seoul, Korea has a poor air quality of 421. 
...
st.write("""The use of the select box is to determine the overall air quality of the Country the user is interested in looking at. 
...
#[CHART1] bar chart w top countries, find top 5 max and add to list
top5_countries=[]
top5_values=[]
...
st.subheader("Top 5 Countries with the Worth Air Quality")
fig, ax = plt.subplots()
...
st.write("""This interactive map showcases the AQI all around the world compared to one another, by selecting different regions, you can see how different the indices are and make conclusions based on latitude and longitude as to why certain areas may have similar AQI’s. 
    Or even the opposite, how polaring regions could have such drastically different AQI’s.""" )
